...
Ask: What does the user need to trust this?

---

## Common Response Parts

Not every response needs every part. The structure should match the user's intent and risk level.

| Part | Description |
|---|---|
| **Main Message** | The primary answer, insight, confirmation, or limitation. |
| **Guidance** | Path, steps, instructions, or supporting detail. |
| **Supporting source / data** | Evidence that helps users trust the response. |
| **Action** | CTA, deep link, review step, or next move. |
| **Fallback / Escalation** | Safe path when AI cannot complete or resolve the request. |
| **Feedback** | User rating or response-quality signal. |
